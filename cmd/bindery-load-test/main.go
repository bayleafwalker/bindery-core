...
func main() {
	...
	flag.StringVar(&bookletName, "booklet", "standard-match", "Booklet name")
		...
		go func(id int) {
			...
			world := &binderyv1alpha1.WorldInstance{
				...
				Spec: binderyv1alpha1.WorldInstanceSpec{
					GameRef:    binderyv1alpha1.ObjectRef{Name: bookletName},
			...
			for {
				...
				case <-time.After(1 * time.Second):
					var currentWorld binderyv1alpha1.WorldInstance
