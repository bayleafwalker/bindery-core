...
kubectl apply -f examples/booklet-bindery-sample/k8s/02-capabilitydefinition-interaction-engine.yaml
...
kubectl apply -f examples/booklet-bindery-sample/k8s/11-modulemanifest-interaction.yaml
